...
export default function Index() {
  return (
    <main className="relative min-h-screen h-full pt-[80px] md:pt-[120px]">
      ...
      <section className="support-the-community px-8 bg-[#FFD800] py-20">
        <h1 className='text-2xl lg:text-4xl text-center pt-8'>Support the Community<span className='italic'>!</span></h1>
        <div className="grid gap-y-6 items-center justify-center place-items-center mt-5">
      ...
      <section className="acrros-the-nation bg-gray-200 py-[50px]">
        ...
        <div className="flex flex-col lg:flex-row items-center pl justify-between gap-y-[60px] md:gap-x-[35px] px-6 md:px-12">
          <div className="bg-white max-w-3xl py-[40px] place-content-center lg:place-content-start  px-[20px] lg:px-[32px] w-[100%] grid rounded lg:h-[340px]">
